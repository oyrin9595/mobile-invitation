...
export type WeddingData = {
  ...
  /** 히어로: dateLine + timeLine(선택) 한 줄 합침, 아래 줄은 venue.name · hall */
  hero: {
    dateLine: string;
    timeLine?: string;
  };
...
export const wedding: WeddingData = {
  ...
  schedule: [
    { label: "예식", datetime: "2026년 5월 23일 토요일 오후 3시 30분" },
  ],
  calendarDate: {
    year: 2026,
    month: 5,
  ...
  directions: {
    venueLabel: "더베르G",
    roadAddress: "서울시 영등포구 국회대로 612 2층 더베르G",
    phone: "02.2088.5272",
    sections: [
      {
        title: "지하철 이용 시",
